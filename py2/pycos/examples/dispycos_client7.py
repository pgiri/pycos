...
# notifications from dispycos scheduler to run jobs at specific remote dispycos
...
def status_proc(computation, njobs, task=None):
    ...
    # in this example at most one task is submitted at a server; depending
    # on computation / needs, many tasks can be simlutaneously submitted /
