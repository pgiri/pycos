...
# computation task is scheduled at a process, as the computation is
# supposed to be CPU heavy (although in this example they are not). Status of
# remote tasks can be monitored in a web browser at http://127.0.0.1:8181

import pycos.dispycos as pycos
