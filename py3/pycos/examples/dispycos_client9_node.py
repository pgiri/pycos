...
def node_available(avail_info, data_file, task=None):
    ...
    # available. 'location' is Location instance of node. When this task
    ...
    # value of task (last value yield'ed or value of 'raise StopIteration')
...
def client_proc(computation, task=None):
    ...
    # execute 10 jobs (tasks) and get their results. Note that number of
